            ...
            <div class="box">
                <div class="col-lg-12">
                    <div class="alert alert-danger">
                        <strong>You must be logged in to view the contact page.</strong>
                    </div>
                    <hr>
                    ...
                    <div class="form-group col-lg-12">
                        <a href="register.php"><button type="submit" id="login" class="btn btn-default">Not a
                                member?Register here</button></a>
                    </div>
                </div>
            </div>
        </div>
